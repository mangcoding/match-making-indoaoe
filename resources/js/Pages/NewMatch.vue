        ...
        <div class="flex flex-col items-center min-h-screen bg-black bg-opacity-50">
            ...
            <form class="max-w-xl p-5 text-center bg-white border border-gray-200 rounded-lg shadow lg:w-full "
                ...
                <div class="flex flex-col items-center gap-5">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none ">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#9DA3AD" stroke-width="2" stroke-linecap="round" />
                                </svg>
                            </div>
                        </div>
                    ...
                    <div v-if="selectedPlayers.length > 0"
                        ...
                        <div class="grid h-full grid-cols-1 gap-2 md:grid-cols-2">
                            <div class="relative" v-for="(p, k) in selectedPlayers" :key="k">
                                ...
                                <button class="absolute -translate-y-1/2 right-4 top-1/2" @click="cancelSelection(k)"><svg
                    ...
                    <div class="w-full ">
                        <button type="button" @click.prevent="buildTeamButtonPressed"
            ...
            <div class="p-5 text-center bg-white rounded-lg" v-if="selectedTeams && selectedTeams[teamIndex].team_a.length > 0">
                ...
                <div class="flex items-center gap-2 pt-5">
                    ...
                    <button @click.prevent="resetTeam"
