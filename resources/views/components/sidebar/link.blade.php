...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-gradient-to-br from-gold-200 via-gold-100 to-gold-200 shadow-lg hover:bg-yellow-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
