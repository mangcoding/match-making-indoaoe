...
@php
    ...
    switch ($variant) {
        case 'primary':
            $variantClasses = 'bg-gradient-to-br from-gold-200 via-gold-100 to-gold-200 text-white hover:bg-yellow-600 focus:ring-gold-300';
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-100 focus:ring-gold-300 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
